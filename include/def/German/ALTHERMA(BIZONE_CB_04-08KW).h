...
{0x10,4,203,1,-1,"Betrieb / Störung#1"},
{0x10,5,204,1,-1,"Störcode#1"},
...
{0x30,0,211,1,-1,"Ventilator 1"},
{0x30,1,211,1,-1,"Ventilator 2"},
{0x30,0,151,2,-1,"Expansionsventils (pls)"},
{0x30,2,151,2,-1,"Y1E-Expansionsventil Mitteldruck Unterkühler"},
...
{0x60,2,315,1,-1,"Innengerät Betriebsart"},
{0x60,2,303,1,-1,"Thermostat#2"},
{0x60,2,302,1,-1,"Frostschutz"},
{0x60,2,301,1,-1,"Leisemodus"},
{0x60,2,300,1,-1,"Frostschutz für Wasserleitung"},
{0x60,3,204,1,-1,"Störcode#2"},
{0x60,4,152,1,-1,"Fehlerdetailcode"},
{0x60,5,203,1,-1,"Betrieb / Störung#2"},
{0x60,6,219,1,-1,"Innengerät Kapazitätscode"},
...
{0x60,12,306,1,-1,"3-Wege-Ventil (Ein: DHW Aus: Raum)"},
{0x60,12,305,1,-1,"BSH"},
...
{0x62,2,307,1,-1,"Nachheizen"},
{0x62,2,306,1,-1,"Speicher Eco"},
{0x62,2,305,1,-1,"Speicher Komfort"},
{0x62,2,304,1,-1,"Hochleistungs Brauchwasser Betrieb"},
...
{0x62,3,105,2,1,"Sollwert Heizungsvorlauf (Zusatz)"},
{0x62,5,105,2,1,"Rücklauf Einstellpunkt"},
...
{0x64,9,301,1,-1,"Hauptpumpe"},
{0x64,10,118,2,1,"Mischer Temperatur"},
